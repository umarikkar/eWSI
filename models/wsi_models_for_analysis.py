...
from models.mil_utils_for_analysis.abmil import *
from models.mil_utils_for_analysis.acmil import ACMIL_GA
from models.mil_utils_for_analysis.transmil import TransMIL
from models.mil_utils_for_analysis.grasp import GRASP
from models.mil_utils_for_analysis.zoommil import ZoomMIL
from models.mil_utils_for_analysis.attention import MaxPooler
from models.mil_utils_for_analysis.DeepAttnMISL_CS_MIL import DeepAttnMIL_Surv
import models.loralib as lora
import torch
from einops import rearrange
from models.mil_utils_for_analysis.snuffy import SnuffyClass
    ...
    def __init__(self, encoder_name, out_features=1, num_segments=3, mil_config='csmil', num_subimgs_train=128, num_subimgs_val=-1):
        ...
        if 'abmil' in mil_config:
            self.agg_and_classify = ABMIL(in_features=self.embed_dim, 
                                               ...
                                               use_tiles_embed=use_tiles_embed)
            ...
            self.agg_and_classify = SnuffyClass(feats_size=self.embed_dim, num_classes=out_features,use_tiles_embed=use_tiles_embed)
