...
import numpy as np
from models.mil_utils.attention import NystromAttention
...
class TransMIL(nn.Module):
    def __init__(self, input_dim=384, hidden_dim=128, n_classes=1, use_tiles_embed=True):
    ...
    def forward(self, features, **kwargs):
        ...
        h = rearrange(features, 'b n m d -> b (n m) d')
